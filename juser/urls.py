...
urlpatterns = patterns('juser.views',
    ...
    (r'^account_list/$', view_splitter, {'su': account_list}),
    (r'^account_add/$', 'account_add'),
    (r'^account_del/$', 'account_del'),
    (r'^account_down_key/$', 'account_down_key'),
    (r'^account_del_ajax/$', 'account_del_ajax'),
    (r'^profile/$', 'profile'),
    (r'^chg_info/$', 'chg_info'),
    (r'^chg_role/$', 'chg_role'),
    (r'^down_key/$', 'down_key'),
